var meuFormulario = document.getElementById("resultado");
...
//Função somar
function somar() {
	<input type="text" id="Número entre 100 a 999"<br>
  //Captura o que está dentro do primeiro input no formulário
  //Number - Transforma o texto capturado em Numero
  let Número entre 100 a 999 = Number(document.getElementById("Número entre 100 a 999").value);
